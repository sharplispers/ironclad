...
The current version of Ironclad is 0.50. It can be downloaded
at [[https://github.com/sharplispers/ironclad/archive/v0.50.tar.gz]].
...
#+BEGIN_EXAMPLE
(defmethod generate-signature-nonce ((key crypto:secp256k1-private-key) message &optional parameters)
