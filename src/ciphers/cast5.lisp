...
(defmacro s-box (s-boxes s-box-index index)
...
(defun cast5-f1 (input mask rotate)
  ...
  (let ((value (rol32 (mod32+ input mask) rotate)))
    ...
    (mod32+ (s-box s-boxes 3 (first-byte value))
            (mod32- (logxor (s-box s-boxes 1 (third-byte value))
                            (s-box s-boxes 0 (fourth-byte value)))
                    (s-box s-boxes 2 (second-byte value))))))
...
(defun cast5-f2 (input mask rotate)
  ...
  (let ((value (rol32 (logxor input mask) rotate)))
    (declare (type (unsigned-byte 32) value))
    (logxor (s-box s-boxes 3 (first-byte value))
            (mod32+ (s-box s-boxes 2 (second-byte value))
                    (mod32- (s-box s-boxes 0 (fourth-byte value))
                            (s-box s-boxes 1 (third-byte value)))))))
...
(defun cast5-f3 (input mask rotate)
  ...
  (let ((value (rol32 (mod32- mask input) rotate)))
    (declare (type (unsigned-byte 32) value))
    (mod32- (logxor (s-box s-boxes 2 (second-byte value))
                    (mod32+ (s-box s-boxes 1 (third-byte value))
                            (s-box s-boxes 0 (fourth-byte value))))
            (s-box s-boxes 3 (first-byte value)))))
