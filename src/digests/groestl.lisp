...
(defmacro groestl-rnd512p (x y r)
...
(defmacro groestl-rnd512q (x y r)
...
(defmacro groestl-rnd1024p (x y r)
...
(defmacro groestl-rnd1024q (x y r)
...
(defun groestl-f512 (state input start)
  ...
  (let ((y (make-array #.+groestl-cols-512+ :element-type '(unsigned-byte 64)))
    ...
    ;; Compute Q(m)
    (groestl-rnd512q z y #x0000000000000000)
    (groestl-rnd512q y z #x0000000000000001)
    (groestl-rnd512q z y #x0000000000000002)
    (groestl-rnd512q y z #x0000000000000003)
    (groestl-rnd512q z y #x0000000000000004)
    (groestl-rnd512q y z #x0000000000000005)
    (groestl-rnd512q z y #x0000000000000006)
    (groestl-rnd512q y z #x0000000000000007)
    (groestl-rnd512q z y #x0000000000000008)
    (groestl-rnd512q y outq #x0000000000000009)

    ;; Compute P(h + m)
    (groestl-rnd512p inp z #x0000000000000000)
    (groestl-rnd512p z y #x0100000000000000)
    (groestl-rnd512p y z #x0200000000000000)
    (groestl-rnd512p z y #x0300000000000000)
    (groestl-rnd512p y z #x0400000000000000)
    (groestl-rnd512p z y #x0500000000000000)
    (groestl-rnd512p y z #x0600000000000000)
    (groestl-rnd512p z y #x0700000000000000)
    (groestl-rnd512p y z #x0800000000000000)
    (groestl-rnd512p z y #x0900000000000000)
  ...
  (let* ((digest-length (digest-length state))
    ...
    (if (= block-size +groestl-size-512+)
        (let ((temp (copy-seq groestl-state))
          ...
          (groestl-rnd512p temp z #x0000000000000000)
          (groestl-rnd512p z y #x0100000000000000)
          (groestl-rnd512p y z #x0200000000000000)
          (groestl-rnd512p z y #x0300000000000000)
          (groestl-rnd512p y z #x0400000000000000)
          ...
          (groestl-rnd512p z y #x0700000000000000)
          (groestl-rnd512p y z #x0800000000000000)
          (groestl-rnd512p z temp #x0900000000000000)
          (dotimes (i +groestl-cols-512+)
